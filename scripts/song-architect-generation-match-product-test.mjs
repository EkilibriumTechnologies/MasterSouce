...
assertIncludes(page, "Your creation workflow", "page orients the creator workflow");
assertIncludes(page, "Now generate this in your music generator", "generated result points to external generation");
...
assertIncludes(panel, "Did the generation follow your blueprint?", "panel is positioned as a return/check step");
...
assertIncludes(panel, "Improve the next generation", "panel positions the derived prompt as iteration");
