...
export const HOME_FAQ_ITEMS: HomeFaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Free gives you unlimited MP3 master downloads and 1 WAV download per month at 16-bit — enough to test the workflow. Creator ($9/mo) adds 25 WAV downloads/month, 24-bit WAV, and adaptive customization. Pro Studio ($24/mo) includes unlimited WAV downloads and 32-bit float for batch work."
  },
  {
